...
def v15_edge(id:, start:, finish:, pid: nil, pid_path: nil, layer: 'Layer0')
  pid ||= id + 100
  pid_path ||= [pid]
  EdgeRecord.new(
    id:           id,
    source:       SourceReference.new(
      ...
      instance_path:        [],
      structural_depth:      pid_path.length - 1,
...
def v15_derived_edge(derived_id:, occurrence_id:, start:, finish:, kind: :edge)
...
test 'V15-1: forward exact duplicate (A->B + A->B, same occurrence) -> apply removes the duplicate' do
  ...
  e1 = v15_edge(id: 0, start: [0.0, 0.0, 0.0], finish: [10.0, 0.0, 0.0], pid_path: [100])
  e2 = v15_edge(id: 1, start: [0.0, 0.0, 0.0], finish: [10.0, 0.0, 0.0], pid_path: [100])
...
test 'V15-2: reversed exact duplicate (A->B + B->A, same occurrence) -> apply removes the duplicate' do
  e1 = v15_edge(id: 0, start: [0.0, 0.0, 0.0], finish: [10.0, 0.0, 0.0], pid_path: [100])
  e2 = v15_edge(id: 1, start: [10.0, 0.0, 0.0], finish: [0.0, 0.0, 0.0], pid_path: [100])
  src = v15_snapshot(edges: [e1, e2])
  records = [
    v15_derived_edge(derived_id: 'der-A', occurrence_id: 'occ-100',
                     start: e1.start_point, finish: e1.end_point),
    v15_derived_edge(derived_id: 'der-B', occurrence_id: 'occ-100',
                     start: e2.start_point, finish: e2.end_point)
  ]
  ws = v15_workspace(snapshot: src, records: records)
  issues = [
...
test 'V15-3: three identical edges (A->B x 3, same occurrence) -> apply produces 1 survivor' do
  e1 = v15_edge(id: 0, start: [0.0, 0.0, 0.0], finish: [10.0, 0.0, 0.0], pid_path: [100])
  e2 = v15_edge(id: 1, start: [0.0, 0.0, 0.0], finish: [10.0, 0.0, 0.0], pid_path: [100])
  e3 = v15_edge(id: 2, start: [0.0, 0.0, 0.0], finish: [10.0, 0.0, 0.0], pid_path: [100])
  src = v15_snapshot(edges: [e1, e2, e3])
  records = [
    v15_derived_edge(derived_id: 'der-edge-0', occurrence_id: 'occ-100',
                     start: e1.start_point, finish: e1.end_point),
    v15_derived_edge(derived_id: 'der-edge-1', occurrence_id: 'occ-100',
                     start: e2.start_point, finish: e2.end_point),
    v15_derived_edge(derived_id: 'der-edge-2', occurrence_id: 'occ-100',
...
test 'V15-4: shared-definition two instances: cross-instance duplicates preserved (different occurrences)' do
  ...
  src = v15_snapshot(edges: [e1, e2])
  records = [
    v15_derived_edge(derived_id: 'der-A', occurrence_id: 'occ-100>200',
                     start: e1.start_point, finish: e1.end_point),
    v15_derived_edge(derived_id: 'der-B', occurrence_id: 'occ-300>400',
                     start: e2.start_point, finish: e2.end_point)
  ]
  ws = v15_workspace(snapshot: src, records: records)
  issues = [
...
test 'V15-5: legitimate short edge is NOT removed (no short-edge deletion policy)' do
  ...
  records = [
    v15_derived_edge(derived_id: 'der-A', occurrence_id: 'occ-100',
                     start: e1.start_point, finish: e1.end_point),
    v15_derived_edge(derived_id: 'der-B', occurrence_id: 'occ-101',
                     start: e2.start_point, finish: e2.end_point)
  ]
  ws = v15_workspace(snapshot: src, records: records)
...
test 'V15-7: same world coords but different source_occurrence_ids preserved (provenance gate)' do
  ...
  e1 = v15_edge(id: 0, start: [0.0, 0.0, 0.0], finish: [10.0, 0.0, 0.0],
                pid_path: [100])
  e2 = v15_edge(id: 1, start: [0.0, 0.0, 0.0], finish: [10.0, 0.0, 0.0],
                pid_path: [200])  # different persistent_id_path
  src = v15_snapshot(edges: [e1, e2])
  records = [
    v15_derived_edge(derived_id: 'der-A', occurrence_id: 'occ-100',
                     start: e1.start_point, finish: e1.end_point),
    v15_derived_edge(derived_id: 'der-B', occurrence_id: 'occ-200',
                     start: e2.start_point, finish: e2.end_point)
  ]
  ws = v15_workspace(snapshot: src, records: records)
  issues = [
...
test 'V15-9: nested transform with same world coords but different persistent_id_path preserved' do
  ...
  e1 = v15_edge(id: 0, start: [0.0, 0.0, 0.0], finish: [10.0, 0.0, 0.0],
                pid_path: [100])
  e2 = v15_edge(id: 1, start: [0.0, 0.0, 0.0], finish: [10.0, 0.0, 0.0],
                pid_path: [100, 200, 300])  # nested inside
  src = v15_snapshot(edges: [e1, e2])
  records = [
    v15_derived_edge(derived_id: 'der-A', occurrence_id: 'occ-100',
                     start: e1.start_point, finish: e1.end_point),
    v15_derived_edge(derived_id: 'der-B', occurrence_id: 'occ-100>200>300',
                     start: e2.start_point, finish: e2.end_point)
  ]
  ws = v15_workspace(snapshot: src, records: records)
  issues = [
...
test 'V15-DET-1: survivor selection is deterministic across rebuilds (same plan)' do
  ...
  records = [
    v15_derived_edge(derived_id: 'zzz-second', occurrence_id: 'occ-100',
                     start: e2.start_point, finish: e2.end_point),
    v15_derived_edge(derived_id: 'aaa-first',  occurrence_id: 'occ-100',
                     start: e1.start_point, finish: e1.end_point)
  ]
  ws = v15_workspace(snapshot: src, records: records)
  issues = [
